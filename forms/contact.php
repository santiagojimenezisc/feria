...
try {
    ...
    $mail->CharSet = 'UTF-8';
    //Recipients
    $mail->setFrom('noreply@educa.org.mx', 'Contacto Feria EDUCA, Ahorra y Emprende 2020');
...
$mail->DKIM_identity = $mail->From;
    ...
    $mail->addAddress('buzon@educa.org.mx');     // Add a recipient
    ...
    $mail->addBCC('coordinacion@educa.org.mx'); 
    $mail->addBCC('nancy.perez@educa.org.mx');
    $mail->addBCC('cristel.ruiz@educa.org.mx');
...
$mail->Subject = 'Contacto Feria EDUCA, Ahorra y Emprende 2020 - '.$asunto.'';
...
<table align="center" cellpadding="0" cellspacing="0" class="force-full-width" height="100%" >
                ...
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" bgcolor="#2F488C">
                  <tr>
                    <td class="headline" style="text-align:center;color: #ffffff;font-size: 20px;">
                      <br>
                      Ha recibido un mensaje <br><br> Contacto Feria EDUCA, Ahorra y Emprende 2020
                    </td>
                  </tr>
                  <tr>
                    <td>
  ...
  $mail->send();
    ...
    echo 'El mensaje no se pudo enviar, intente nuevamente. Error: ', $mail->ErrorInfo;
}
