...
$loop=mysqli_query($con,"SELECT nombre,email,id FROM Emprendimientos WHERE id=28 ORDER by id") or die ("Error de base"); 
...
$mail->DKIM_identity = $mail->From;
  ...
  $nombre = $datos['nombre'];
  $id = $datos['id'];
  $buscapuntos = mysqli_query($con,"SELECT puntos FROM PUNTOS where id='$id'") or die ("Error en busqueda");
  $coins = mysqli_fetch_array($buscapuntos);
  $puntos = $coins['puntos'];
  if($puntos>0){

    $mail->addAddress($correo);     // Add a recipient
    //$mail->addCC('marialepanduro1016@gmail.com');
...
$mail->Subject = '¡Canjea ya tus EDUCACOINS! - Feria EDUCA, Ahorra y Emprende 2020';
...
¡Corre a canjear tus EDUCACOINS por increíbles premios! 
</div>
                ...
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" bgcolor="#2F488C">
                  <tr>
                    <td class="headline" style="text-align:center;color: #ffffff;font-size: 20px;">
                      <br>
                      Hola "'.$nombre.'", corre a canjear tus <img src="https://educa.org.mx/FeriaEDUCA2020/assets/img/coin.png" width="20" alt="coin"> <b>EDUCACOINS</b>, ingresa ahora y elige tu premio.
                      <br><br>
                    </td>
                  </tr>
                  <tr>
                      ...
                      <center>
                        <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="85%">
                          <tr>
                            ...
                            Contraseña: <b>FeriaEDUCA2020</b><br><br>
                            <b>Tus EDUCACOINS disponibles: '.$puntos.' </b><img src="https://educa.org.mx/FeriaEDUCA2020/assets/img/coin.png" width="12" alt="coin"><br><br>
                            <b>¡Tenemos premios que puedes canjear desde sólo 1 <img src="https://educa.org.mx/FeriaEDUCA2020/assets/img/coin.png" width="12" alt="coin"> EDUCACOIN!<br><br>
                            <center><img src="http:educa.org.mx/FeriaEDUCA2020/assets/img/reloj.gif"></center>
                            <br><br>
                            <div><!--[if mso]>
                        <center>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://educa.org.mx/FeriaEDUCA2020/premios.php" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#178f8f">
                          <w:anchorlock/>
                        <![endif]-->
                            <center><a href="https://educa.org.mx/FeriaEDUCA2020/premios.php" target="_blank"
                      style="background-color:#178f8f;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Canjear ahora</a></center>
                        <!--[if mso]>
                          </center>
                        </v:roundrect>
                      <![endif]--></div>
