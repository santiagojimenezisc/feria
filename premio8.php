...
<div class="modal-content">
      ...
      <div class="modal-body aviso">
        ...
        <div class="row">
         <div class="col-md-4">
        <center><img class="card-img-top" src="assets/img/premios/45506.jpg" alt="goma"></center>
      </div>
      <div class="col-md-8">
        <?php
          if($namee==''){
        echo'<p>Premio: <b>LAPICES DE COLORES CRAYOLA TRIANGULARES (12 PZS.)</b><br>Costo de canje: 50 <img src="assets/img/coin.png" style="width: 1rem" alt="coin"></p>';
          ...
          elseif ($puntos>=50){echo'<p>Premio: <b>LAPICES DE COLORES CRAYOLA TRIANGULARES (12 PZS.)</b><br>Costo de canje: 50 <img src="assets/img/coin.png" style="width: 1rem" alt="coin"><br> EDUCACOINS disponibles: '.$puntos.' <img src="assets/img/coin.png" style="width: 1rem" alt="coin"></p>
            <div class="form-group">
              <input type="hidden" class="form-control" name="premio" id="premio"  value="8"/>
              ...
              <input type="hidden" class="form-control" name="costo" id="costo"  value="50"/>
        ...
        <button onclick="canjear(this);" type="submit" id="canjea" class="btn btn-danger" style="margin-right: auto;margin-left: auto;">Canjear</button>
          ...
          elseif($puntos<50){
            echo'<p>Premio: <b>LAPICES DE COLORES CRAYOLA TRIANGULARES (12 PZS.)</b><br>Costo de canje: 50 <img src="assets/img/coin.png" style="width: 1rem" alt="coin"><br> EDUCACOINS disponibles: '.$puntos.' <img src="assets/img/coin.png" style="width: 1rem" alt="coin"></p>';
