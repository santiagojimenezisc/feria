...
$buscapuntos=mysqli_query($con,"SELECT puntos FROM PUNTOS where id='$ide'") or die ("Error en canje");
$imprimepuntos=mysqli_fetch_array($buscapuntos);
$puntos=$imprimepuntos['puntos'];
...
$buscapremio=mysqli_query($con,"SELECT * FROM CTLGO_PREMIO where id='$premio'") or die ("Error de canje");
$buscapremios=mysqli_fetch_array($buscapremio);
$descpremio=$buscapremios['descripcion'];
$rutaimg=$buscapremios['imagen'];


$canje = mysqli_query($con,"INSERT INTO CANJE VALUES (NULL,'$nombre','$email','$name','$apellido','$dir','$telefono','$premio','$navegador','$ip',NOW())") or die ("Error en canje");
$resta = mysqli_query($con,"UPDATE PUNTOS set puntos='$nuevo1' where id='$ide'") or die ("Error de canje");
...
$mail->Subject = 'Canje de premio Feria EDUCA, Ahorra y Emprende 2020';
...
Detalles de canje de premio Feria EDUCA, Ahorra y Emprende 2020
</div
<table align="center" cellpadding="0" cellspacing="0" class="force-full-width" height="100%" >
                ...
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" bgcolor="#2F488C">
                  <tr>
                    <td class="headline" style="text-align:center;color: #ffffff;font-size: 20px;">
                      <br>
                      Hola '.$name.' '.$apellido.', el canje de tu premio en la Feria Virtual EDUCA, Ahorra y Emprende 2020 ha sido exitoso.
                    </td>
                  </tr>
                  <tr>
                    <td>
                      ...
                      <center>
                        <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="85%">
                          <tr>
                            ...
                            <br>
                             A continuación te mostramos los detalles del canje: <br><br>
                             Nombre: '.$name.' '.$apellido.'<br><br>
                             Correo electr&oacute;nico: '.$email.'<br><br>
                             Dirección: '.$dir.'<br><br>
                             Teléfono: '.$telefono.'<br><br>
                             Premio canjeado: '.$descpremio.'<br><br>
                             <center><img src="https://educa.org.mx/FeriaEDUCA2020/assets/img/premios/'.$rutaimg.'" alt="premio" width="200"></center>
                            <br>
                            <br>
                            <div><!--[if mso]>
                        <center>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://educa.org.mx/FeriaEDUCA2020/" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#178f8f">
                          <w:anchorlock/>
                        <![endif]-->
                            <center><a href="https://educa.org.mx/FeriaEDUCA2020/" target="_blank"
                      style="background-color:#178f8f;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Feria EDUCA 2020</a></center>
                        <!--[if mso]>
                          </center>
                        </v:roundrect>
                      <![endif]--></div>
  ...
  $mail->send();
    ...
    echo 'Canje no exitoso. Error: ', $mail->ErrorInfo;
}
