      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav mb-md-3">
           <li class="nav-item">
              <a class="nav-link active" href="emprendimientos.php">
                <i class="ni ni-bullet-list-67 text-default"></i>
        ...
        <div class="col-xl-12">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Resultados por Emprendimiento: Insignias y EDUCACOINS</h3>
            </div>
            <!-- Light table -->
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="budget">Innovación</th>
                    <th scope="col" class="sort" data-sort="status">Empatía</th>
                    <th scope="col" class="sort" data-sort="status">Alianzas</th>
                    <th scope="col" class="sort" data-sort="completion">EDUCACOINS</th>
                  </tr>
                </thead>
                <tbody class="list">
                  ...
                  <?
                    ...
                    $nombre=$row['nombre'];
                    $ide=$row['id'];
                    $innovacion = mysqli_query($con,"SELECT id FROM INSIGNIAS where id_emprendimiento='$ide' and insignia=1") or die ("Error de conexión");
                    $totalinovacion = mysqli_num_rows($innovacion);
                    $empatia = mysqli_query($con,"SELECT id FROM INSIGNIAS where id_emprendimiento='$ide' and insignia=2") or die ("Error de conexión");
                    $totalempatia = mysqli_num_rows($empatia);
                    $alianzas = mysqli_query($con,"SELECT id FROM INSIGNIAS where id_emprendimiento='$ide' and insignia=3") or die ("Error de conexión");
                    $totalalianzas = mysqli_num_rows($alianzas);
