...
$mail->DKIM_identity = $mail->From;
    ...
    $mail->addAddress('arlet.grm@gmail.com');     // Add a recipient
...
$mail->Subject = 'Error en canje de premio Feria EDUCA, Ahorra y Emprende 2020';
...
Ha habido un error en el canje de premio Feria EDUCA, Ahorra y Emprende 2020
</div
                ...
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" bgcolor="#2F488C">
                  <tr>
                    <td class="headline" style="text-align:center;color: #ffffff;font-size: 20px;">
                      <br>
                      Hola Arlet Reyes Mejía, el canje de tu premio en la Feria Virtual EDUCA, Ahorra y Emprende 2020 ha tenido un error.
                    </td>
                  </tr>
                  <tr>
                    <td>
                      ...
                      <center>
                        <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="85%">
                          <tr>
                            ...
                            <br>
                             <b>Te invitamos a ingresar nuevamente y realizar el canje de tu premio, ya que en este momento no tienes ningún canje de premio registrado.</b> <br><br>
                            <div><!--[if mso]>
                        <center>
