...
<div class="modal-content">
      ...
      <div class="modal-body aviso">
        ...
        <div class="row">
         <div class="col-md-4">
        <center><img class="card-img-top" src="assets/img/premios/premio2.jpg" alt="goma"></center>
      </div>
      <div class="col-md-8">
        <?php
          if($namee==''){
        echo'<p>Premio: <b>Control Bluetooth para Videojuegos de Smartphone, Compatible con Android y Windows</b><br>Costo de canje: 390 <img src="assets/img/coin.png" style="width: 1rem" alt="coin"></p>';
          ...
          elseif ($puntos>=390){echo'<p>Premio: <b>Control Bluetooth para Videojuegos de Smartphone, Compatible con Android y Windows</b><br>Costo de canje: 390 <img src="assets/img/coin.png" style="width: 1rem" alt="coin"><br> EDUCACOINS disponibles: '.$puntos.' <img src="assets/img/coin.png" style="width: 1rem" alt="coin"></p>
            <div class="form-group">
              <input type="hidden" class="form-control" name="premio" id="premio"  value="15"/>
              ...
              <input type="hidden" class="form-control" name="costo" id="costo"  value="390"/>
        ...
        <button onclick="canjear(this);" type="submit" id="canjea" class="btn btn-danger" style="margin-right: auto;margin-left: auto;">Canjear</button>
          ...
          elseif($puntos<390){
            echo'<p>Premio: <b>Control Bluetooth para Videojuegos de Smartphone, Compatible con Android y Windows</b><br>Costo de canje: 390 <img src="assets/img/coin.png" style="width: 1rem" alt="coin"><br> EDUCACOINS disponibles: '.$puntos.' <img src="assets/img/coin.png" style="width: 1rem" alt="coin"></p>';
